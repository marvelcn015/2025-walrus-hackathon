...
export interface WalrusApiInterface {
     ...
     * @param {string} dealId Deal ID this file belongs to: - Use &#x60;\\\&quot;pending\\\&quot;&#x60; for M&amp;A agreement uploads before deal creation (Level 1 auth, no transaction) - Use actual deal object ID (0x...) for financial documents (Level 2 auth, returns transaction) 
