...
import type { WalrusUploadResponseNextStep } from './WalrusUploadResponseNextStep';
import {
    WalrusUploadResponseNextStepFromJSON,
    WalrusUploadResponseNextStepFromJSONTyped,
    WalrusUploadResponseNextStepToJSON,
} from './WalrusUploadResponseNextStep';
...
export interface WalrusUploadResponse {
    ...
    /**
     * 
     * @type {WalrusBlobReference}
     * @memberof WalrusUploadResponse
     */
    blobReference?: WalrusBlobReference;
    /**
     * 
     * @type {WalrusUploadResponseNextStep}
     * @memberof WalrusUploadResponse
     */
    nextStep?: WalrusUploadResponseNextStep;
}

/**
 * Check if a given object implements the WalrusUploadResponse interface.
 */
export function instanceOfWalrusUploadResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "blobId" in value;
    isInstance = isInstance && "commitment" in value;
...
export function WalrusUploadResponseFromJSON(json: any): WalrusUploadResponse {
    return WalrusUploadResponseFromJSONTyped(json, false);
}

export function WalrusUploadResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalrusUploadResponse {
    ...
    return {
        ...
        'blobReference': !exists(json, 'blobReference') ? undefined : WalrusBlobReferenceFromJSON(json['blobReference']),
        'nextStep': !exists(json, 'nextStep') ? undefined : WalrusUploadResponseNextStepFromJSON(json['nextStep']),
    };
}

export function WalrusUploadResponseToJSON(value?: WalrusUploadResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'blobReference': WalrusBlobReferenceToJSON(value.blobReference),
        'nextStep': WalrusUploadResponseNextStepToJSON(value.nextStep),
    };
}
