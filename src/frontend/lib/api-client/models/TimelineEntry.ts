 ...
 */
export function instanceOfTimelineEntry(value: object): boolean {
    let isInstance = true;
    ...
    isInstance = isInstance && "submittedBy" in value;
...
export function TimelineEntryToJSON(value?: TimelineEntry | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
