...
import type { AttestKPIResponseAttestation } from './AttestKPIResponseAttestation';
import {
    AttestKPIResponseAttestationFromJSON,
    AttestKPIResponseAttestationFromJSONTyped,
    AttestKPIResponseAttestationToJSON,
} from './AttestKPIResponseAttestation';
 ...
 * 
 * @export
 * @interface AttestKPIResponse
 */
export interface AttestKPIResponse {
    /**
     * 
     * @type {AttestKPIResponseAttestation}
     * @memberof AttestKPIResponse
     */
    attestation?: AttestKPIResponseAttestation;
    /**
     * 
...
/**
 * Check if a given object implements the AttestKPIResponse interface.
 */
export function instanceOfAttestKPIResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function AttestKPIResponseFromJSON(json: any): AttestKPIResponse {
    return AttestKPIResponseFromJSONTyped(json, false);
}

export function AttestKPIResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttestKPIResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'attestation': !exists(json, 'attestation') ? undefined : AttestKPIResponseAttestationFromJSON(json['attestation']),
        'transaction': !exists(json, 'transaction') ? undefined : ProposeKPIResponseTransactionFromJSON(json['transaction']),
    };
}

export function AttestKPIResponseToJSON(value?: AttestKPIResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'attestation': AttestKPIResponseAttestationToJSON(value.attestation),
