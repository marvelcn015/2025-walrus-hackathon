 ...
 * Data upload status
 * @export
 * @interface PeriodSummaryDataUploadProgress
 */
export interface PeriodSummaryDataUploadProgress {
    /**
     * Number of uploaded blobs
     * @type {number}
     * @memberof PeriodSummaryDataUploadProgress
     */
    blobCount: number;
    /**
...
/**
 * Check if a given object implements the PeriodSummaryDataUploadProgress interface.
 */
export function instanceOfPeriodSummaryDataUploadProgress(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "blobCount" in value;

    return isInstance;
}

export function PeriodSummaryDataUploadProgressFromJSON(json: any): PeriodSummaryDataUploadProgress {
    return PeriodSummaryDataUploadProgressFromJSONTyped(json, false);
}

export function PeriodSummaryDataUploadProgressFromJSONTyped(json: any, ignoreDiscriminator: boolean): PeriodSummaryDataUploadProgress {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'blobCount': json['blobCount'],
        'lastUploadAt': !exists(json, 'lastUploadAt') ? undefined : (new Date(json['lastUploadAt'])),
        'completeness': !exists(json, 'completeness') ? undefined : json['completeness'],
    };
}

export function PeriodSummaryDataUploadProgressToJSON(value?: PeriodSummaryDataUploadProgress | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'lastUploadAt': value.lastUploadAt === undefined ? undefined : (value.lastUploadAt.toISOString()),
