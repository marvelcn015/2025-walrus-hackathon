...
import type { CreateDealResponseTransaction } from './CreateDealResponseTransaction';
import {
    CreateDealResponseTransactionFromJSON,
    CreateDealResponseTransactionFromJSONTyped,
    CreateDealResponseTransactionToJSON,
} from './CreateDealResponseTransaction';
...
export interface CreateDealResponse {
     ...
     * 
     * @type {Deal}
     * @memberof CreateDealResponse
     */
    deal: Deal;
    /**
     * 
     * @type {CreateDealResponseTransaction}
     * @memberof CreateDealResponse
     */
    transaction: CreateDealResponseTransaction;
}

/**
 * Check if a given object implements the CreateDealResponse interface.
 */
export function instanceOfCreateDealResponse(value: object): boolean {
    let isInstance = true;
...
export function CreateDealResponseFromJSON(json: any): CreateDealResponse {
    return CreateDealResponseFromJSONTyped(json, false);
}

export function CreateDealResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateDealResponse {
    ...
    return {
        ...
        'transaction': CreateDealResponseTransactionFromJSON(json['transaction']),
    };
}

export function CreateDealResponseToJSON(value?: CreateDealResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transaction': CreateDealResponseTransactionToJSON(value.transaction),
    };
}
