...
import type { SealPolicy } from './SealPolicy';
import {
    SealPolicyFromJSON,
    SealPolicyFromJSONTyped,
    SealPolicyToJSON,
} from './SealPolicy';
 ...
 * 
 * @export
 * @interface GetSealPolicyResponse
 */
export interface GetSealPolicyResponse {
    /**
     * 
     * @type {SealPolicy}
     * @memberof GetSealPolicyResponse
     */
    policy?: SealPolicy;
}

/**
 * Check if a given object implements the GetSealPolicyResponse interface.
 */
export function instanceOfGetSealPolicyResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function GetSealPolicyResponseFromJSON(json: any): GetSealPolicyResponse {
    return GetSealPolicyResponseFromJSONTyped(json, false);
}

export function GetSealPolicyResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSealPolicyResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'policy': !exists(json, 'policy') ? undefined : SealPolicyFromJSON(json['policy']),
    };
}

export function GetSealPolicyResponseToJSON(value?: GetSealPolicyResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'policy': SealPolicyToJSON(value.policy),
    };
}
