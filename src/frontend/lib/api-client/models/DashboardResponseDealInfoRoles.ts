 ...
 * Role assignments
 * @export
 * @interface DashboardResponseDealInfoRoles
 */
export interface DashboardResponseDealInfoRoles {
    /**
     * 
     * @type {string}
     * @memberof DashboardResponseDealInfoRoles
     */
    buyer?: string;
    /**
     * 
...
/**
 * Check if a given object implements the DashboardResponseDealInfoRoles interface.
 */
export function instanceOfDashboardResponseDealInfoRoles(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DashboardResponseDealInfoRolesFromJSON(json: any): DashboardResponseDealInfoRoles {
    return DashboardResponseDealInfoRolesFromJSONTyped(json, false);
}

export function DashboardResponseDealInfoRolesFromJSONTyped(json: any, ignoreDiscriminator: boolean): DashboardResponseDealInfoRoles {
...
export function DashboardResponseDealInfoRolesToJSON(value?: DashboardResponseDealInfoRoles | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
