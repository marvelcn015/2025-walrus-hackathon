 ...
 * @export
 * @interface DealBlobsListResponseSealPolicy
 */
export interface DealBlobsListResponseSealPolicy {
    /**
     * Seal package ID
     * @type {string}
     * @memberof DealBlobsListResponseSealPolicy
     */
    packageId?: string;
    /**
     * Whitelist object ID for access control
     * @type {string}
     * @memberof DealBlobsListResponseSealPolicy
     */
...
/**
 * Check if a given object implements the DealBlobsListResponseSealPolicy interface.
 */
export function instanceOfDealBlobsListResponseSealPolicy(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DealBlobsListResponseSealPolicyFromJSON(json: any): DealBlobsListResponseSealPolicy {
    return DealBlobsListResponseSealPolicyFromJSONTyped(json, false);
}

export function DealBlobsListResponseSealPolicyFromJSONTyped(json: any, ignoreDiscriminator: boolean): DealBlobsListResponseSealPolicy {
    ...
    return {
        ...
        'whitelistObjectId': !exists(json, 'whitelistObjectId') ? undefined : json['whitelistObjectId'],
    };
}

export function DealBlobsListResponseSealPolicyToJSON(value?: DealBlobsListResponseSealPolicy | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'whitelistObjectId': value.whitelistObjectId,
    };
}
