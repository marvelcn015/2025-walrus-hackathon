 ...
 * @export
 * @interface DealBlobItem
 */
export interface DealBlobItem {
    /**
     * Walrus blob ID
     * @type {string}
     * @memberof DealBlobItem
     */
    blobId: string;
    /**
     * Type of data stored
     ...
     * @memberof DealBlobItem
     */
    dataType: DealBlobItemDataTypeEnum;
    /**
 ...
 * @export
 */
export const DealBlobItemDataTypeEnum = {
...
export type DealBlobItemDataTypeEnum = typeof DealBlobItemDataTypeEnum[keyof typeof DealBlobItemDataTypeEnum];


/**
 * Check if a given object implements the DealBlobItem interface.
 */
export function instanceOfDealBlobItem(value: object): boolean {
    let isInstance = true;
...
export function DealBlobItemFromJSON(json: any): DealBlobItem {
    return DealBlobItemFromJSONTyped(json, false);
}

export function DealBlobItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): DealBlobItem {
...
export function DealBlobItemToJSON(value?: DealBlobItem | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
