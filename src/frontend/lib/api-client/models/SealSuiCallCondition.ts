...
/**
 * An on-chain Sui smart contract call used for authorization.
 * @export
 * @interface SealSuiCallCondition
 */
export interface SealSuiCallCondition {
    /**
     * The Sui package (contract) ID to call.
     * @type {string}
     * @memberof SealSuiCallCondition
     */
    _package: string;
    /**
    ...
    module: string;
    /**
     * The function to call for authorization. This function must return a boolean.
     * @type {string}
     * @memberof SealSuiCallCondition
     */
    _function: string;
...
/**
 * Check if a given object implements the SealSuiCallCondition interface.
 */
export function instanceOfSealSuiCallCondition(value: object): boolean {
    let isInstance = true;
...
export function SealSuiCallConditionFromJSON(json: any): SealSuiCallCondition {
    return SealSuiCallConditionFromJSONTyped(json, false);
}

export function SealSuiCallConditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SealSuiCallCondition {
...
export function SealSuiCallConditionToJSON(value?: SealSuiCallCondition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
