 ...
 * Period date range
 * @export
 * @interface PeriodSummaryDateRange
 */
export interface PeriodSummaryDateRange {
    /**
     * 
     * @type {Date}
     * @memberof PeriodSummaryDateRange
     */
    start: Date;
    /**
     * 
...
/**
 * Check if a given object implements the PeriodSummaryDateRange interface.
 */
export function instanceOfPeriodSummaryDateRange(value: object): boolean {
    let isInstance = true;
...
export function PeriodSummaryDateRangeFromJSON(json: any): PeriodSummaryDateRange {
    return PeriodSummaryDateRangeFromJSONTyped(json, false);
}

export function PeriodSummaryDateRangeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PeriodSummaryDateRange {
...
export function PeriodSummaryDateRangeToJSON(value?: PeriodSummaryDateRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
