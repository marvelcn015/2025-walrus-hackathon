...
import type { DashboardResponseDealInfo } from './DashboardResponseDealInfo';
import {
    DashboardResponseDealInfoFromJSON,
    DashboardResponseDealInfoFromJSONTyped,
    DashboardResponseDealInfoToJSON,
} from './DashboardResponseDealInfo';
import type { DealEvent } from './DealEvent';
import {
    DealEventFromJSON,
    DealEventFromJSONTyped,
    DealEventToJSON,
} from './DealEvent';
...
import {
    PeriodSummaryFromJSON,
    PeriodSummaryFromJSONTyped,
    PeriodSummaryToJSON,
} from './PeriodSummary';

/**
 * Comprehensive dashboard view for a deal
 * @export
...
export interface DashboardResponse {
    /**
     * 
     * @type {DashboardResponseDealInfo}
     * @memberof DashboardResponse
     */
    dealInfo: DashboardResponseDealInfo;
    /**
     * Summary of all periods
     * @type {Array<PeriodSummary>}
     * @memberof DashboardResponse
     */
    periodsSummary: Array<PeriodSummary>;
    /**
     * Recent activity events
     * @type {Array<DealEvent>}
     * @memberof DashboardResponse
     */
    recentEvents: Array<DealEvent>;
    /**
     * 
     * @type {HealthMetrics}
     * @memberof DashboardResponse
...
export function instanceOfDashboardResponse(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "dealInfo" in value;
    isInstance = isInstance && "periodsSummary" in value;
    isInstance = isInstance && "recentEvents" in value;
    isInstance = isInstance && "healthMetrics" in value;
...
export function DashboardResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DashboardResponse {
    ...
    return {
        ...
        'dealInfo': DashboardResponseDealInfoFromJSON(json['dealInfo']),
        'periodsSummary': ((json['periodsSummary'] as Array<any>).map(PeriodSummaryFromJSON)),
        'recentEvents': ((json['recentEvents'] as Array<any>).map(DealEventFromJSON)),
        'healthMetrics': HealthMetricsFromJSON(json['healthMetrics']),
    };
}
...
export function DashboardResponseToJSON(value?: DashboardResponse | null): any {
    ...
    return {
        ...
        'dealInfo': DashboardResponseDealInfoToJSON(value.dealInfo),
        'periodsSummary': ((value.periodsSummary as Array<any>).map(PeriodSummaryToJSON)),
        'recentEvents': ((value.recentEvents as Array<any>).map(DealEventToJSON)),
        'healthMetrics': HealthMetricsToJSON(value.healthMetrics),
    };
}
