...
export interface GetParametersResponse {
     ...
     * Deal ID
     * @type {string}
     * @memberof GetParametersResponse
     */
    dealId: string;
    /**
     * 
    ...
    /**
     * Whether parameters are locked on-chain
     * @type {boolean}
     * @memberof GetParametersResponse
     */
    locked: boolean;
    /**
     * When parameters were locked
     * @type {Date}
     * @memberof GetParametersResponse
     */
    lockedAt?: Date;
...
/**
 * Check if a given object implements the GetParametersResponse interface.
 */
export function instanceOfGetParametersResponse(value: object): boolean {
    let isInstance = true;
...
export function GetParametersResponseFromJSON(json: any): GetParametersResponse {
    return GetParametersResponseFromJSONTyped(json, false);
}

export function GetParametersResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetParametersResponse {
    ...
    return {
        ...
        'dealId': json['dealId'],
        'periods': ((json['periods'] as Array<any>).map(PeriodFromJSON)),
        'locked': json['locked'],
        'lockedAt': !exists(json, 'lockedAt') ? undefined : (new Date(json['lockedAt'])),
        'summary': !exists(json, 'summary') ? undefined : json['summary'],
    };
}

export function GetParametersResponseToJSON(value?: GetParametersResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'dealId': value.dealId,
        'periods': ((value.periods as Array<any>).map(PeriodToJSON)),
        'locked': value.locked,
        'lockedAt': value.lockedAt === undefined ? undefined : (value.lockedAt.toISOString()),
