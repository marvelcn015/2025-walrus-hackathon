...
/**
 * Encoded parameters for on-chain storage
 * @export
 * @interface SetParametersResponseParameters
 */
export interface SetParametersResponseParameters {
    /**
     * 
     * @type {Array<Period>}
     * @memberof SetParametersResponseParameters
     */
    periods?: Array<Period>;
}

/**
 * Check if a given object implements the SetParametersResponseParameters interface.
 */
export function instanceOfSetParametersResponseParameters(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SetParametersResponseParametersFromJSON(json: any): SetParametersResponseParameters {
    return SetParametersResponseParametersFromJSONTyped(json, false);
}

export function SetParametersResponseParametersFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetParametersResponseParameters {
...
export function SetParametersResponseParametersToJSON(value?: SetParametersResponseParameters | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
