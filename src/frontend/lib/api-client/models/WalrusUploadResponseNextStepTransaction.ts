...
/**
 * Transaction to register blob on Sui
 * @export
 * @interface WalrusUploadResponseNextStepTransaction
 */
export interface WalrusUploadResponseNextStepTransaction {
    /**
     * Unsigned transaction bytes
     * @type {string}
     * @memberof WalrusUploadResponseNextStepTransaction
     */
    txBytes?: string;
    /**
     * 
...
/**
 * Check if a given object implements the WalrusUploadResponseNextStepTransaction interface.
 */
export function instanceOfWalrusUploadResponseNextStepTransaction(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WalrusUploadResponseNextStepTransactionFromJSON(json: any): WalrusUploadResponseNextStepTransaction {
    return WalrusUploadResponseNextStepTransactionFromJSONTyped(json, false);
}

export function WalrusUploadResponseNextStepTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalrusUploadResponseNextStepTransaction {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'txBytes': !exists(json, 'txBytes') ? undefined : json['txBytes'],
        'description': !exists(json, 'description') ? undefined : json['description'],
    };
}

export function WalrusUploadResponseNextStepTransactionToJSON(value?: WalrusUploadResponseNextStepTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
