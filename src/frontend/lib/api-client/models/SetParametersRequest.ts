...
import type { SetParametersRequestPeriodsInner } from './SetParametersRequestPeriodsInner';
import {
    SetParametersRequestPeriodsInnerFromJSON,
    SetParametersRequestPeriodsInnerFromJSONTyped,
    SetParametersRequestPeriodsInnerToJSON,
} from './SetParametersRequestPeriodsInner';
...
export interface SetParametersRequest {
    /**
     * Array of period configurations
     * @type {Array<SetParametersRequestPeriodsInner>}
     * @memberof SetParametersRequest
     */
    periods: Array<SetParametersRequestPeriodsInner>;
}

/**
 * Check if a given object implements the SetParametersRequest interface.
 */
export function instanceOfSetParametersRequest(value: object): boolean {
    let isInstance = true;
...
export function SetParametersRequestFromJSON(json: any): SetParametersRequest {
    return SetParametersRequestFromJSONTyped(json, false);
}

export function SetParametersRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetParametersRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'periods': ((json['periods'] as Array<any>).map(SetParametersRequestPeriodsInnerFromJSON)),
    };
}

export function SetParametersRequestToJSON(value?: SetParametersRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'periods': ((value.periods as Array<any>).map(SetParametersRequestPeriodsInnerToJSON)),
    };
}
