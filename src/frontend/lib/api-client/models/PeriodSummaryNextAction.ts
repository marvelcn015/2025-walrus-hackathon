...
/**
 * Suggested next action for this period
 * @export
 * @interface PeriodSummaryNextAction
 */
export interface PeriodSummaryNextAction {
    /**
     * Action to take
     * @type {string}
     * @memberof PeriodSummaryNextAction
     */
    action?: string;
    /**
     ...
     * @memberof PeriodSummaryNextAction
     */
    actor?: PeriodSummaryNextActionActorEnum;
    /**
     * Action deadline
     * @type {Date}
     * @memberof PeriodSummaryNextAction
 ...
 * @export
 */
export const PeriodSummaryNextActionActorEnum = {
    Buyer: 'buyer',
    Seller: 'seller',
    Auditor: 'auditor'
} as const;
export type PeriodSummaryNextActionActorEnum = typeof PeriodSummaryNextActionActorEnum[keyof typeof PeriodSummaryNextActionActorEnum];


/**
 * Check if a given object implements the PeriodSummaryNextAction interface.
 */
export function instanceOfPeriodSummaryNextAction(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PeriodSummaryNextActionFromJSON(json: any): PeriodSummaryNextAction {
    return PeriodSummaryNextActionFromJSONTyped(json, false);
}

export function PeriodSummaryNextActionFromJSONTyped(json: any, ignoreDiscriminator: boolean): PeriodSummaryNextAction {
...
export function PeriodSummaryNextActionToJSON(value?: PeriodSummaryNextAction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'action': value.action,
        'actor': value.actor,
        'deadline': value.deadline === undefined ? undefined : (value.deadline.toISOString().substring(0,10)),
    };
}
