...
import type { SettlementResponseSettlement } from './SettlementResponseSettlement';
import {
    SettlementResponseSettlementFromJSON,
    SettlementResponseSettlementFromJSONTyped,
    SettlementResponseSettlementToJSON,
} from './SettlementResponseSettlement';
import type { SettlementResponseTransaction } from './SettlementResponseTransaction';
import {
    SettlementResponseTransactionFromJSON,
    SettlementResponseTransactionFromJSONTyped,
    SettlementResponseTransactionToJSON,
} from './SettlementResponseTransaction';
...
export interface SettlementResponse {
    /**
     * 
     * @type {SettlementResponseSettlement}
     * @memberof SettlementResponse
     */
    settlement: SettlementResponseSettlement;
    /**
     * 
     * @type {SettlementResponseTransaction}
     * @memberof SettlementResponse
     */
    transaction: SettlementResponseTransaction;
}
...
export function SettlementResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementResponse {
    ...
    return {
        ...
        'settlement': SettlementResponseSettlementFromJSON(json['settlement']),
        'transaction': SettlementResponseTransactionFromJSON(json['transaction']),
    };
}
...
export function SettlementResponseToJSON(value?: SettlementResponse | null): any {
    ...
    return {
        ...
        'settlement': SettlementResponseSettlementToJSON(value.settlement),
        'transaction': SettlementResponseTransactionToJSON(value.transaction),
    };
}
