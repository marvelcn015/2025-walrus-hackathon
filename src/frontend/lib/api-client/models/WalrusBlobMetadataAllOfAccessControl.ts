 ...
 * @export
 * @interface WalrusBlobMetadataAllOfAccessControl
 */
export interface WalrusBlobMetadataAllOfAccessControl {
    /**
     * Seal policy ID
     * @type {string}
     * @memberof WalrusBlobMetadataAllOfAccessControl
     */
    sealPolicyId?: string;
    /**
     * Roles that can decrypt this blob
     * @type {Array<string>}
     * @memberof WalrusBlobMetadataAllOfAccessControl
     */
    allowedRoles?: Array<WalrusBlobMetadataAllOfAccessControlAllowedRolesEnum>;
}
 ...
 * @export
 */
export const WalrusBlobMetadataAllOfAccessControlAllowedRolesEnum = {
    Buyer: 'buyer',
    Seller: 'seller',
    Auditor: 'auditor'
} as const;
export type WalrusBlobMetadataAllOfAccessControlAllowedRolesEnum = typeof WalrusBlobMetadataAllOfAccessControlAllowedRolesEnum[keyof typeof WalrusBlobMetadataAllOfAccessControlAllowedRolesEnum];


/**
 * Check if a given object implements the WalrusBlobMetadataAllOfAccessControl interface.
 */
export function instanceOfWalrusBlobMetadataAllOfAccessControl(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WalrusBlobMetadataAllOfAccessControlFromJSON(json: any): WalrusBlobMetadataAllOfAccessControl {
    return WalrusBlobMetadataAllOfAccessControlFromJSONTyped(json, false);
}

export function WalrusBlobMetadataAllOfAccessControlFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalrusBlobMetadataAllOfAccessControl {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'sealPolicyId': !exists(json, 'sealPolicyId') ? undefined : json['sealPolicyId'],
        'allowedRoles': !exists(json, 'allowedRoles') ? undefined : json['allowedRoles'],
    };
}

export function WalrusBlobMetadataAllOfAccessControlToJSON(value?: WalrusBlobMetadataAllOfAccessControl | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'sealPolicyId': value.sealPolicyId,
