...
export function KPIAttestationFromJSON(json: any): KPIAttestation {
    return KPIAttestationFromJSONTyped(json, false);
}

export function KPIAttestationFromJSONTyped(json: any, ignoreDiscriminator: boolean): KPIAttestation {
...
export function KPIAttestationToJSON(value?: KPIAttestation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
