...
export interface ConflictError {
     ...
     * @memberof ConflictError
     */
    statusCode: ConflictErrorStatusCodeEnum;
    /**
 ...
 * @export
 */
export const ConflictErrorErrorEnum = {
    ConflictError: 'ConflictError'
} as const;
export type ConflictErrorErrorEnum = typeof ConflictErrorErrorEnum[keyof typeof ConflictErrorErrorEnum];

/**
 * @export
 */
export const ConflictErrorStatusCodeEnum = {
    NUMBER_409: 409
} as const;
export type ConflictErrorStatusCodeEnum = typeof ConflictErrorStatusCodeEnum[keyof typeof ConflictErrorStatusCodeEnum];
...
export function ConflictErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConflictError {
    ...
    return {
        ...
        'conflictReason': !exists(json, 'conflictReason') ? undefined : json['conflictReason'],
    };
}
