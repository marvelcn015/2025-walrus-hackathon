...
export interface NotFoundError {
     ...
     * @memberof NotFoundError
     */
    statusCode: NotFoundErrorStatusCodeEnum;
    /**
 ...
 * @export
 */
export const NotFoundErrorStatusCodeEnum = {
    NUMBER_404: 404
} as const;
export type NotFoundErrorStatusCodeEnum = typeof NotFoundErrorStatusCodeEnum[keyof typeof NotFoundErrorStatusCodeEnum];
