...
/**
 * Unsigned transaction to lock parameters on-chain
 * @export
 * @interface SetParametersResponseTransaction
 */
export interface SetParametersResponseTransaction {
    /**
     * Base64 encoded transaction bytes
     * @type {string}
     * @memberof SetParametersResponseTransaction
     */
    txBytes: string;
    /**
     * 
    ...
    description: string;
    /**
     * Important warning about parameter locking
     * @type {string}
     * @memberof SetParametersResponseTransaction
     */
    warning: string;
...
/**
 * Check if a given object implements the SetParametersResponseTransaction interface.
 */
export function instanceOfSetParametersResponseTransaction(value: object): boolean {
    let isInstance = true;
...
export function SetParametersResponseTransactionFromJSON(json: any): SetParametersResponseTransaction {
    return SetParametersResponseTransactionFromJSONTyped(json, false);
}

export function SetParametersResponseTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetParametersResponseTransaction {
...
export function SetParametersResponseTransactionToJSON(value?: SetParametersResponseTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
