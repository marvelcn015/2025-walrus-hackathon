...
import type { ValidationErrorAllOfValidationErrors } from './ValidationErrorAllOfValidationErrors';
import {
    ValidationErrorAllOfValidationErrorsFromJSON,
    ValidationErrorAllOfValidationErrorsFromJSONTyped,
    ValidationErrorAllOfValidationErrorsToJSON,
} from './ValidationErrorAllOfValidationErrors';
...
export interface ValidationError {
    ...
    /**
     * 
     * @type {Array<ValidationErrorAllOfValidationErrors>}
     * @memberof ValidationError
     */
    validationErrors?: Array<ValidationErrorAllOfValidationErrors>;
}
...
export function ValidationErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ValidationError {
    ...
    return {
        ...
        'validationErrors': !exists(json, 'validationErrors') ? undefined : ((json['validationErrors'] as Array<any>).map(ValidationErrorAllOfValidationErrorsFromJSON)),
    };
}
...
export function ValidationErrorToJSON(value?: ValidationError | null): any {
    ...
    return {
        ...
        'validationErrors': value.validationErrors === undefined ? undefined : ((value.validationErrors as Array<any>).map(ValidationErrorAllOfValidationErrorsToJSON)),
    };
}
