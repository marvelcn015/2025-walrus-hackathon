...
import type { SettlementResponseTransactionTokenTransfer } from './SettlementResponseTransactionTokenTransfer';
import {
    SettlementResponseTransactionTokenTransferFromJSON,
    SettlementResponseTransactionTokenTransferFromJSONTyped,
    SettlementResponseTransactionTokenTransferToJSON,
} from './SettlementResponseTransactionTokenTransfer';

/**
 * Unsigned settlement transaction
 * @export
 * @interface SettlementResponseTransaction
 */
export interface SettlementResponseTransaction {
    /**
     * Base64 encoded transaction bytes
     * @type {string}
     * @memberof SettlementResponseTransaction
     */
    txBytes: string;
    /**
     * 
    ...
    /**
     * 
     * @type {SettlementResponseTransactionTokenTransfer}
     * @memberof SettlementResponseTransaction
     */
    tokenTransfer?: SettlementResponseTransactionTokenTransfer;
}

/**
 * Check if a given object implements the SettlementResponseTransaction interface.
 */
export function instanceOfSettlementResponseTransaction(value: object): boolean {
    let isInstance = true;
...
export function SettlementResponseTransactionFromJSON(json: any): SettlementResponseTransaction {
    return SettlementResponseTransactionFromJSONTyped(json, false);
}

export function SettlementResponseTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementResponseTransaction {
    ...
    return {
        ...
        'tokenTransfer': !exists(json, 'tokenTransfer') ? undefined : SettlementResponseTransactionTokenTransferFromJSON(json['tokenTransfer']),
    };
}

export function SettlementResponseTransactionToJSON(value?: SettlementResponseTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'tokenTransfer': SettlementResponseTransactionTokenTransferToJSON(value.tokenTransfer),
    };
}
