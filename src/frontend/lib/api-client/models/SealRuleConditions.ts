...
import type { SealSuiCallCondition } from './SealSuiCallCondition';
import {
    SealSuiCallConditionFromJSON,
    SealSuiCallConditionFromJSONTyped,
    SealSuiCallConditionToJSON,
} from './SealSuiCallCondition';

/**
 * Conditions that must be met to grant access.
 * @export
 * @interface SealRuleConditions
 */
export interface SealRuleConditions {
    /**
     * The required Sui network.
     * @type {string}
     * @memberof SealRuleConditions
     */
    suichain: string;
    /**
     * 
     * @type {SealSuiCallCondition}
     * @memberof SealRuleConditions
     */
    suicall: SealSuiCallCondition;
}

/**
 * Check if a given object implements the SealRuleConditions interface.
 */
export function instanceOfSealRuleConditions(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "suichain" in value;
    isInstance = isInstance && "suicall" in value;

    return isInstance;
}

export function SealRuleConditionsFromJSON(json: any): SealRuleConditions {
    return SealRuleConditionsFromJSONTyped(json, false);
}

export function SealRuleConditionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SealRuleConditions {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'suichain': json['sui:chain'],
        'suicall': SealSuiCallConditionFromJSON(json['sui:call']),
    };
}

export function SealRuleConditionsToJSON(value?: SealRuleConditions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'sui:chain': value.suichain,
        'sui:call': SealSuiCallConditionToJSON(value.suicall),
    };
}
