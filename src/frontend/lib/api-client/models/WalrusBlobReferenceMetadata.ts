 ...
 * @export
 * @interface WalrusBlobReferenceMetadata
 */
export interface WalrusBlobReferenceMetadata {
    /**
     * Original filename
     * @type {string}
     * @memberof WalrusBlobReferenceMetadata
     */
    filename?: string;
    /**
     * MIME type
    ...
    description?: string;
    /**
     * Associated period ID
     * @type {string}
     * @memberof WalrusBlobReferenceMetadata
     */
    periodId?: string;
    /**
     * Whether the blob contains encrypted data
     * @type {boolean}
     * @memberof WalrusBlobReferenceMetadata
     */
    encrypted?: boolean;
...
/**
 * Check if a given object implements the WalrusBlobReferenceMetadata interface.
 */
export function instanceOfWalrusBlobReferenceMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WalrusBlobReferenceMetadataFromJSON(json: any): WalrusBlobReferenceMetadata {
    return WalrusBlobReferenceMetadataFromJSONTyped(json, false);
}

export function WalrusBlobReferenceMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalrusBlobReferenceMetadata {
...
export function WalrusBlobReferenceMetadataToJSON(value?: WalrusBlobReferenceMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
