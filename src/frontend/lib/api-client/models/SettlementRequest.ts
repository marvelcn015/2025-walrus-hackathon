...
export interface SettlementRequest {
     ...
     * 
     * @type {number}
     * @memberof SettlementRequest
     */
    confirmedPayout: number;
}

/**
 * Check if a given object implements the SettlementRequest interface.
 */
export function instanceOfSettlementRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "confirmedPayout" in value;

    return isInstance;
}

export function SettlementRequestFromJSON(json: any): SettlementRequest {
    return SettlementRequestFromJSONTyped(json, false);
}

export function SettlementRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'confirmedPayout': json['confirmedPayout'],
    };
}

export function SettlementRequestToJSON(value?: SettlementRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'confirmedPayout': value.confirmedPayout,
    };
}
