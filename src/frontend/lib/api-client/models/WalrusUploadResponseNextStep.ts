...
import type { WalrusUploadResponseNextStepTransaction } from './WalrusUploadResponseNextStepTransaction';
import {
    WalrusUploadResponseNextStepTransactionFromJSON,
    WalrusUploadResponseNextStepTransactionFromJSONTyped,
    WalrusUploadResponseNextStepTransactionToJSON,
} from './WalrusUploadResponseNextStepTransaction';

/**
 * Instructions for next step
 * @export
 * @interface WalrusUploadResponseNextStep
 */
export interface WalrusUploadResponseNextStep {
    /**
     * What to do next
     * @type {string}
     * @memberof WalrusUploadResponseNextStep
     */
    action?: WalrusUploadResponseNextStepActionEnum;
    /**
     * 
     * @type {string}
     * @memberof WalrusUploadResponseNextStep
    ...
    /**
     * 
     * @type {WalrusUploadResponseNextStepTransaction}
     * @memberof WalrusUploadResponseNextStep
     */
    transaction?: WalrusUploadResponseNextStepTransaction;
}
 ...
 * @export
 */
export const WalrusUploadResponseNextStepActionEnum = {
    RegisterOnChain: 'register_on_chain'
} as const;
export type WalrusUploadResponseNextStepActionEnum = typeof WalrusUploadResponseNextStepActionEnum[keyof typeof WalrusUploadResponseNextStepActionEnum];


/**
 * Check if a given object implements the WalrusUploadResponseNextStep interface.
 */
export function instanceOfWalrusUploadResponseNextStep(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function WalrusUploadResponseNextStepFromJSON(json: any): WalrusUploadResponseNextStep {
    return WalrusUploadResponseNextStepFromJSONTyped(json, false);
}

export function WalrusUploadResponseNextStepFromJSONTyped(json: any, ignoreDiscriminator: boolean): WalrusUploadResponseNextStep {
    ...
    return {
        ...
        'transaction': !exists(json, 'transaction') ? undefined : WalrusUploadResponseNextStepTransactionFromJSON(json['transaction']),
    };
}

export function WalrusUploadResponseNextStepToJSON(value?: WalrusUploadResponseNextStep | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'transaction': WalrusUploadResponseNextStepTransactionToJSON(value.transaction),
    };
}
