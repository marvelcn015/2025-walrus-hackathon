...
/**
 * Unsigned transaction to update roles on-chain
 * @export
 * @interface UpdateDealRolesResponseTransaction
 */
export interface UpdateDealRolesResponseTransaction {
    /**
     * Base64 encoded transaction bytes
     * @type {string}
     * @memberof UpdateDealRolesResponseTransaction
     */
    txBytes: string;
    /**
...
/**
 * Check if a given object implements the UpdateDealRolesResponseTransaction interface.
 */
export function instanceOfUpdateDealRolesResponseTransaction(value: object): boolean {
    let isInstance = true;
...
export function UpdateDealRolesResponseTransactionFromJSON(json: any): UpdateDealRolesResponseTransaction {
    return UpdateDealRolesResponseTransactionFromJSONTyped(json, false);
}

export function UpdateDealRolesResponseTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateDealRolesResponseTransaction {
...
export function UpdateDealRolesResponseTransactionToJSON(value?: UpdateDealRolesResponseTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
