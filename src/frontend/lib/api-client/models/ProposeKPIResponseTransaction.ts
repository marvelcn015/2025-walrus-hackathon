 ...
 * 
 * @export
 * @interface ProposeKPIResponseTransaction
 */
export interface ProposeKPIResponseTransaction {
    /**
     * 
     * @type {string}
     * @memberof ProposeKPIResponseTransaction
     */
    txBytes?: string;
    /**
     * 
...
/**
 * Check if a given object implements the ProposeKPIResponseTransaction interface.
 */
export function instanceOfProposeKPIResponseTransaction(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProposeKPIResponseTransactionFromJSON(json: any): ProposeKPIResponseTransaction {
    return ProposeKPIResponseTransactionFromJSONTyped(json, false);
}

export function ProposeKPIResponseTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProposeKPIResponseTransaction {
...
export function ProposeKPIResponseTransactionToJSON(value?: ProposeKPIResponseTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
