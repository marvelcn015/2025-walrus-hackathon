...
import type { SealRuleConditions } from './SealRuleConditions';
import {
    SealRuleConditionsFromJSON,
    SealRuleConditionsFromJSONTyped,
    SealRuleConditionsToJSON,
} from './SealRuleConditions';

/**
 * A single rule within a Seal policy.
 * @export
 * @interface SealRule
 */
export interface SealRule {
    ...
    /**
     * 
     * @type {SealRuleConditions}
     * @memberof SealRule
     */
    conditions: SealRuleConditions;
}

/**
 * Check if a given object implements the SealRule interface.
 */
export function instanceOfSealRule(value: object): boolean {
    let isInstance = true;
...
export function SealRuleFromJSON(json: any): SealRule {
    return SealRuleFromJSONTyped(json, false);
}

export function SealRuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): SealRule {
    ...
    return {
        ...
        'conditions': SealRuleConditionsFromJSON(json['conditions']),
    };
}

export function SealRuleToJSON(value?: SealRule | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'conditions': SealRuleConditionsToJSON(value.conditions),
    };
}
