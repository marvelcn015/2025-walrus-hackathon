...
/**
 * Settlement information for a period
 * @export
 * @interface SettlementInfo
 */
export interface SettlementInfo {
    /**
     * Whether settlement has been executed
     * @type {boolean}
    ...
    settledAt?: Date;
    /**
     * Actual payout amount transferred
     * @type {number}
     * @memberof SettlementInfo
     */
    payoutAmount?: number;
    /**
     * Sui transaction hash for settlement
     * @type {string}
     * @memberof SettlementInfo
     */
    txHash?: string;
    /**
     * Sui address that received the payout
     * @type {string}
     * @memberof SettlementInfo
     */
    recipient?: string;
...
/**
 * Check if a given object implements the SettlementInfo interface.
 */
export function instanceOfSettlementInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SettlementInfoFromJSON(json: any): SettlementInfo {
    return SettlementInfoFromJSONTyped(json, false);
}

export function SettlementInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementInfo {
...
export function SettlementInfoToJSON(value?: SettlementInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
