 ...
 * @export
 * @interface SettlementResponseTransactionTokenTransfer
 */
export interface SettlementResponseTransactionTokenTransfer {
    /**
     * 
     * @type {number}
     * @memberof SettlementResponseTransactionTokenTransfer
     */
    amount?: number;
    /**
     * 
    ...
    currency?: string;
    /**
     * Source address (escrow/treasury)
     * @type {string}
     * @memberof SettlementResponseTransactionTokenTransfer
     */
    from?: string;
    /**
     * Destination address (seller)
     * @type {string}
     * @memberof SettlementResponseTransactionTokenTransfer
     */
    to?: string;
...
/**
 * Check if a given object implements the SettlementResponseTransactionTokenTransfer interface.
 */
export function instanceOfSettlementResponseTransactionTokenTransfer(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SettlementResponseTransactionTokenTransferFromJSON(json: any): SettlementResponseTransactionTokenTransfer {
    return SettlementResponseTransactionTokenTransferFromJSONTyped(json, false);
}

export function SettlementResponseTransactionTokenTransferFromJSONTyped(json: any, ignoreDiscriminator: boolean): SettlementResponseTransactionTokenTransfer {
...
export function SettlementResponseTransactionTokenTransferToJSON(value?: SettlementResponseTransactionTokenTransfer | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
