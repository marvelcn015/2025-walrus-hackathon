 ...
 * 
 * @export
 * @interface ProposeKPIResponseCalculatedPayout
 */
export interface ProposeKPIResponseCalculatedPayout {
    /**
     * 
     * @type {number}
     * @memberof ProposeKPIResponseCalculatedPayout
     */
    amount?: number;
    /**
     * 
...
/**
 * Check if a given object implements the ProposeKPIResponseCalculatedPayout interface.
 */
export function instanceOfProposeKPIResponseCalculatedPayout(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProposeKPIResponseCalculatedPayoutFromJSON(json: any): ProposeKPIResponseCalculatedPayout {
    return ProposeKPIResponseCalculatedPayoutFromJSONTyped(json, false);
}

export function ProposeKPIResponseCalculatedPayoutFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProposeKPIResponseCalculatedPayout {
...
export function ProposeKPIResponseCalculatedPayoutToJSON(value?: ProposeKPIResponseCalculatedPayout | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
