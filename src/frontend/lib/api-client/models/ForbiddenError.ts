...
export interface ForbiddenError {
     ...
     * @memberof ForbiddenError
     */
    statusCode: ForbiddenErrorStatusCodeEnum;
    /**
 ...
 * @export
 */
export const ForbiddenErrorErrorEnum = {
    ForbiddenError: 'ForbiddenError'
} as const;
export type ForbiddenErrorErrorEnum = typeof ForbiddenErrorErrorEnum[keyof typeof ForbiddenErrorErrorEnum];

/**
 * @export
 */
export const ForbiddenErrorStatusCodeEnum = {
    NUMBER_403: 403
} as const;
export type ForbiddenErrorStatusCodeEnum = typeof ForbiddenErrorStatusCodeEnum[keyof typeof ForbiddenErrorStatusCodeEnum];
...
export function ForbiddenErrorFromJSONTyped(json: any, ignoreDiscriminator: boolean): ForbiddenError {
    ...
    return {
        ...
        'requiredRole': !exists(json, 'requiredRole') ? undefined : json['requiredRole'],
    };
}
