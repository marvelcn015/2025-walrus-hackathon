...
/**
 * Update role assignments for a deal
 * @export
 * @interface UpdateDealRolesRequest
 */
export interface UpdateDealRolesRequest {
    /**
     * New buyer address (optional)
     * @type {string}
     * @memberof UpdateDealRolesRequest
     */
    buyerAddress?: string;
    /**
     * New seller address (optional)
     * @type {string}
     * @memberof UpdateDealRolesRequest
     */
    sellerAddress?: string;
    /**
     * New auditor address (optional)
     * @type {string}
     * @memberof UpdateDealRolesRequest
     */
...
/**
 * Check if a given object implements the UpdateDealRolesRequest interface.
 */
export function instanceOfUpdateDealRolesRequest(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function UpdateDealRolesRequestFromJSON(json: any): UpdateDealRolesRequest {
    return UpdateDealRolesRequestFromJSONTyped(json, false);
}

export function UpdateDealRolesRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateDealRolesRequest {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'buyerAddress': !exists(json, 'buyerAddress') ? undefined : json['buyerAddress'],
...
export function UpdateDealRolesRequestToJSON(value?: UpdateDealRolesRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
