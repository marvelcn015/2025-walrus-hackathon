...
/**
 * Check if a given object implements the DataTimelineResponse interface.
 */
export function instanceOfDataTimelineResponse(value: object): boolean {
    let isInstance = true;
...
export function DataTimelineResponseFromJSON(json: any): DataTimelineResponse {
    return DataTimelineResponseFromJSONTyped(json, false);
}

export function DataTimelineResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DataTimelineResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'items': ((json['items'] as Array<any>).map(TimelineEntryFromJSON)),
        'total': json['total'],
...
export function DataTimelineResponseToJSON(value?: DataTimelineResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'items': ((value.items as Array<any>).map(TimelineEntryToJSON)),
        'total': value.total,
